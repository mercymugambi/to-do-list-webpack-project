  ...
  removeIcons.forEach((icon) => {
    icon.addEventListener('click', (event) => {
      ...
      if (checkbox.checked) {
        ...
        // Update the index of the remaining tasks in the array
